            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="mb-0">Library Category</h5>
                        @can('update-category', auth()->user())
                            <a href="{{ route('library-category-new') }}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add Library Category</a>
                        @endcan
                    </div>
                        ...
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        <td class="text-sm font-weight-normal">{{ $category->library_category }}</td>
                                        
                                        <td class="text-sm font-weight-normal">{{ $category->created_at }}</td>
                                        <td class="text-sm">
                                            <span class="d-flex">
                                                @can('update-category', auth()->user())
                                                    <a href="{{ route('library-category-edit', $category->id) }}" class="me-3" data-bs-toggle="tooltip"
                                                        data-bs-original-title="Edit category">
                                                        <i class="fas fa-user-edit text-secondary"></i>
                                                    </a>
                                                    <form action="{{ route('library-category-destroy', $category->id) }}" method="post">
                                                        @csrf
