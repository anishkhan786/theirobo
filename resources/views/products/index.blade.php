                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @if (!config('app.is_demo'))
                            <a href="{{ route('products-new') }}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add
                            Product</a>
                        @endif
                    </div>
                            ...
                            <tbody>
                                @foreach ($products as $key=> $product)
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">{{ $product->p_name }}</td>
                                        <td class="text-sm font-weight-normal">{{ $product->p_description }}</td>
                                        <td class="text-sm">
                                            <span class="d-flex">
