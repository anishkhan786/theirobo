...
@section('content')
    <nav class="navbar navbar-main navbar-expand-lg  px-0 mx-4 shadow-none border-radius-xl z-index-sticky " id="navbarBlur"
        ...
        <div class="container-fluid py-1 px-3">
            @include('layouts.navbars.auth.topnav', ['title' => 'Slider Management'])
                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between">
                        ...
                        @if (!config('app.is_demo'))
                            <a href="{{ route('slider-new') }}" class="btn bg-gradient-dark btn-sm float-end mb-0">Add
                            Slider</a>
                        @endif
                    </div>
                            ...
                            <tbody>
                                @foreach ($sliders as $key=> $slider)
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">{{ $slider->title }}</td>
                                        <td class="text-sm font-weight-normal">{{ $slider->description }}</td>
                                        <td class="text-sm">
                                            <span class="d-flex">
                                                @can('manage-users', auth()->user())
                                                    <a href="{{ route('slider-edit', $slider->id) }}" class="me-3"
