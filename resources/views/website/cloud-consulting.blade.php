...
@section('title', 'Cloud Consulting — IROBO AI AND ROBOTICS')
...
<section class="our-solution section-spacing">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="{{ asset('assets/img/cloud-consulting.webp') }}" class="img-fluid rounded shadow" alt="Cloud Consulting Services">
            </div>
...
<section class="section-spacing">
    <div class="container">
        <div class="premium-cta text-center">
            ...
            <a href="{{ url('services/cloud-consulting/purchase-cloud-consultation') }}" class="btn theme-button-one btn-lg mt-4">
