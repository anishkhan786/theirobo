...
@section('content')
			...
			<div id="theme-main-banner" class="banner-one">
				@foreach(slider_get() as $slide)
					<div data-src="/upload/slider/{{$slide->image}}">
						<div class="camera_caption">
							<div class="container">
								<p class="wow fadeInUp animated">{{$slide->title}}</p>
								<h1 class="wow fadeInUp animated" data-wow-delay="0.2s">{{$slide->description}}</h1>
								<a href="{{ route('w-aboutUs') }}" class="theme-button-one wow fadeInUp animated" data-wow-delay="0.39s">ABOUT US</a>
							</div> <!-- /.container -->
						</div> <!-- /.camera_caption -->
					</div>
				@endforeach
			...
			<div class="callout-banner section-spacing">
				<div class="container clearfix">
					...
					<a href="{{ route('w-contactUs') }}" class="theme-button-one">Contact Us</a>
				</div>
			</div> <!-- /.callout-banner -->
					...
					<div class="container">
						<div class="row no-gutters">
							<div class="col-lg-7 col-12 text">
								...
								<img src="{{asset('/assets/website/images/home/sign.png')}}" alt="" class="sign">
							</div> <!-- /.col- -->
