...
<head>
		...
		<!-- Favicon -->
		<link rel="icon" type="image/png" sizes="56x56" href="/upload/website-logo/{{website_logo()}}">
		<!-- Main style sheet -->
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-4 col-12">
								<ul class="social-icon">
									<a href="{{ route('w-contactUs') }}" class="btn btn-primary btn-sm">Request Demo</a>
						...
						<div class=" clearfix">
							<!-- ============== Menu Warpper ================ -->
					   		<div class="menu-wrapper float-left">
								   ...
								   <ul class="clearfix">
									<li class="{{ Route::currentRouteName() == 'w-home' ? 'active' : '' }}">
										<a href="{{ route('w-home') }}">Home</a>
									</li>

									<li class="{{ Route::currentRouteName() == 'w-products' ? 'active' : '' }}">
										<a href="{{ route('w-products') }}">Products</a>
									</li>
									...
									<li class="dropdown 
										{{ in_array(Route::currentRouteName(), ['w-services','w-cloud','w-robotic','w-ai']) ? 'active' : '' }}">
										
										<a href="{{ route('w-services') }}">Services</a>

										<ul class="dropdown-menu">
											<li class="{{ Route::currentRouteName() == 'w-cloud' ? 'active' : '' }}">
												<a href="{{ route('w-cloud') }}" >Cloud Consulting</a>
											</li>
											<li class="{{ Route::currentRouteName() == 'w-robotic' ? 'active' : '' }}">
												<a href="{{ route('w-robotic') }}" >Robotic Consulting</a>
											</li>
											<li class="{{ Route::currentRouteName() == 'w-ai' ? 'active' : '' }}">
												<a href="{{ route('w-ai') }}" >AI Consulting</a>
											</li>
										</ul>
									</li>

									
									<li class="{{ Route::currentRouteName() == 'w-technology' ? 'active' : '' }}">
										<a href="{{ route('w-technology') }}">Technology</a>
									</li>
									<li class="{{ Route::currentRouteName() == 'w-industries' ? 'active' : '' }}">
										<a href="{{ route('w-industries') }}">Industries</a>
									</li><li class="{{ Route::currentRouteName() == 'w-aboutUs' ? 'active' : '' }}">
										<a href="{{ route('w-aboutUs') }}">About Us</a>
									</li>
									<!-- <li class="{{ Route::currentRouteName() == 'w-aboutUs' ? 'active' : '' }}">
										<a href="{{ route('w-aboutUs') }}">Team</a>
									</li> -->

									<li class="{{ Route::currentRouteName() == 'w-investors' ? 'active' : '' }}">
										<a href="{{ route('w-investors') }}">Investors</a>
									</li>

									<li class="{{ Route::currentRouteName() == 'w-contactUs' ? 'active' : '' }}">
										<a href="{{ route('w-contactUs') }}">Contact-Us</a>
									</li>
								</ul>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-lg-3 col-sm-6 col-12 footer-list">
								...
								<ul>
									<li><a href="{{ route('w-aboutUs') }}">About us</a></li>
									<li><a href="{{ route('w-services') }}">Services</a></li>
									<li><a href="{{ route('w-products') }}">Products</a></li>
									<li><a href="{{ route('w-contactUs') }}">Contact us</a></li>
								</ul>
							</div> <!-- /.footer-list -->
