...
@section('title', 'Robotic Consulting — IROBO')
...
<section class="inner-hero cloud-hero">
    ...
    <div class="hero-content container">
        ...
        <div class="hero-actions">
            <a href="{{ route('w-contactUs') }}" class="btn btn-primary">Get Free Consultation</a>
            <a href="{{ route('w-services') }}" class="btn btn-outline">View All Services</a>
        </div>
    </div>
</section>
<!-- =============================================
...
<div class="our-solution section-spacing">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-6">
                <img src="{{ asset('assets/img/robotic-consulting.png') }}"
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="cta-box text-center">
                    ...
                    <a href="{{ route('purchase.robotic.consultation') }}"
