    ...
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 card-bottom-lenght">
                <div class="tech-card h-100">
                    <div class="tech-icon">
                        <i class="bi bi-<?php echo e($feature['icon']); ?>"></i>
                    </div>
        ...
        <div class="row align-items-center mt-5 pt-4">
            ...
            <div class="col-lg-6 text-center tech-img">
                <img src="<?php echo e(asset('assets/img/tech-diagram-placeholder.png')); ?>"
...
<?php echo $__env->make('website.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\anish\Downloads\app\resources\views/website/technology.blade.php ENDPATH**/ ?>