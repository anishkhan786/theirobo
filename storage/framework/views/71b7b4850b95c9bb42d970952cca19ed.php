						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-4 col-12">
								<ul class="social-icon">
									<a href="<?php echo e(route('w-contactUs')); ?>" class="btn btn-primary btn-sm">Request Demo</a>
        							<a href="#" class="btn btn-secondary btn-sm">Partner With Us</a>
						...
						<div class=" clearfix">
							<!-- ============== Menu Warpper ================ -->
					   		<div class="menu-wrapper float-left">
								   ...
								   <ul class="clearfix">
									<li class="<?php echo e(Route::currentRouteName() == 'w-home' ? 'active' : ''); ?>">
										<a href="<?php echo e(route('w-home')); ?>">Home</a>
									</li>

									<li class="<?php echo e(Route::currentRouteName() == 'w-products' ? 'active' : ''); ?>">
										<a href="<?php echo e(route('w-products')); ?>">Products</a>
									</li>
									...
									<li class="dropdown 
										<?php echo e(in_array(Route::currentRouteName(), ['w-services','w-cloud','w-robotic','w-ai']) ? 'active' : ''); ?>">
										
										<a href="<?php echo e(route('w-services')); ?>">Services</a>

										<ul class="dropdown-menu">
											<li class="<?php echo e(Route::currentRouteName() == 'w-cloud' ? 'active' : ''); ?>">
												<a href="<?php echo e(route('w-cloud')); ?>" >Cloud Consulting</a>
											</li>
											<li class="<?php echo e(Route::currentRouteName() == 'w-robotic' ? 'active' : ''); ?>">
												<a href="<?php echo e(route('w-robotic')); ?>" >Robotic Consulting</a>
											</li>
											<li class="<?php echo e(Route::currentRouteName() == 'w-ai' ? 'active' : ''); ?>">
												<a href="<?php echo e(route('w-ai')); ?>" >AI Consulting</a>
											</li>
										</ul>
									</li>

									
									<li class="<?php echo e(Route::currentRouteName() == 'w-technology' ? 'active' : ''); ?>">
										<a href="<?php echo e(route('w-technology')); ?>">Technology</a>
									</li>
									<li class="<?php echo e(Route::currentRouteName() == 'w-industries' ? 'active' : ''); ?>">
										<a href="<?php echo e(route('w-industries')); ?>">Industries</a>
									</li><li class="<?php echo e(Route::currentRouteName() == 'w-aboutUs' ? 'active' : ''); ?>">
										<a href="<?php echo e(route('w-aboutUs')); ?>">About Us</a>
									</li>
									<!-- <li class="<?php echo e(Route::currentRouteName() == 'w-aboutUs' ? 'active' : ''); ?>">
										<a href="<?php echo e(route('w-aboutUs')); ?>">Team</a>
									</li> -->

									<li class="<?php echo e(Route::currentRouteName() == 'w-investors' ? 'active' : ''); ?>">
										<a href="<?php echo e(route('w-investors')); ?>">Investors</a>
									</li>

									<li class="<?php echo e(Route::currentRouteName() == 'w-contactUs' ? 'active' : ''); ?>">
										<a href="<?php echo e(route('w-contactUs')); ?>">Contact-Us</a>
									</li>
								</ul>
...
</html><?php /**PATH C:\Users\anish\Downloads\app\resources\views/website/layouts/app.blade.php ENDPATH**/ ?>