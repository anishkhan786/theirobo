    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#consultationServicesExamples" class="nav-link <?php echo e((Route::currentRouteName() == 'consultationServices' ) ? 'active' : ''); ?>"
                ...
                <div class="collapse  <?php echo e((Route::currentRouteName() == 'consultation-services-feature.index' || Route::currentRouteName() == 'consultation-services.index' ) ? 'show' : ''); ?> " id="consultationServicesExamples">
                    <ul class="nav ms-4">
                        <li class="nav-item">
                            <a class="nav-link <?php echo e(str_contains(request()->url(), 'consultation-services.index') == true ? 'active' : ''); ?>" href="<?php echo e(route('consultation-services.index')); ?>">
                                <span class="sidenav-mini-icon"> CS </span>
                                <span class="sidenav-normal"> Consultation Services </span>
                            </a>
                            <a class="nav-link <?php echo e(str_contains(request()->url(), 'consultation-services-feature.index') == true ? 'active' : ''); ?>" href="<?php echo e(route('consultation-services-feature.index')); ?>">
...
<?php /**PATH C:\Users\anish\Downloads\app\resources\views/layouts/navbars/auth/sidenav.blade.php ENDPATH**/ ?>